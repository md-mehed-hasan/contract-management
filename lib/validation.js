...
export const ALLOWED_TYPES = ['pdf', 'doc', 'docx'];
...
export const sendContractSchema = z
  ...
  .refine((data) => data.documentId || data.templateId, {
    message: 'Choose a document or a template',
    path: ['documentId']
  });
...
export function validateUpload(file) {
  ...
  if (!ALLOWED_TYPES.includes(type)) return 'Only PDF, DOC, and DOCX files are allowed';
